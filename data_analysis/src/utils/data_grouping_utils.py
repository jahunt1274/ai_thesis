...
from typing import List, Dict, Any, Callable, Optional, Set, Tuple, TypeVar, Generic
...
class DataGroupingUtils:
    ...
    @staticmethod
    def group_by_func(data: List[T], key_func: Callable[[T], Any]) -> Dict[Any, List[T]]:
        """
    ...
    @staticmethod
    def group_values_by_range(values: List[float], 
                            ranges: List[Tuple[float, float]]) -> Dict[str, List[float]]:
        """
    ...
    @staticmethod
    def nested_grouping(data: List[Dict[str, Any]], 
                       primary_key: str, 
                       secondary_key: str) -> Dict[Any, Dict[Any, List[Dict[str, Any]]]]:
        """
    ...
    @staticmethod
    def find_relationships(primary_data: List[Dict[str, Any]],
                          secondary_data: List[Dict[str, Any]],
                          primary_key: str,
                          secondary_key: str) -> Dict[Any, List[Dict[str, Any]]]:
        """
    ...
    @staticmethod
    def group_into_categories(items: List[Dict[str, Any]], 
                            key: str,
                            category_map: Dict[str, List[str]]) -> Dict[str, List[Dict[str, Any]]]:
        """
