...
class FileHandler:
    ...
    def save_csv(self, data: List, filepath: str, fieldnames: Optional[List[str]] = None, **kwargs) -> bool:
        """
    ...
    def get_latest_file(self, directory: str, pattern: Optional[str] = None) -> Optional[str]:
        """
